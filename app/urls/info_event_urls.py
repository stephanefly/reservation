...
urlpatterns = [
    ...
    path('last_rappel_devis_client/<int:event_id>/', last_rappel_devis_client, name='last_rappel_devis_client'),
    ...
    path('test_mail_devis_client/<int:event_id>/', view_test_mail_devis, name='view_test_mail_devis'),
