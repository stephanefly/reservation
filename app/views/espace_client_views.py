...
@require_http_methods(["POST"])
def edit_music(request, event_id):
    return update_event_and_redirect(request, event_id, 'url_music_360', 'event_template', 'choix_client')
...
def relance_espace_client(request, event_id):
    ...
    send_mail_event(event, 'relance_espace_client')
